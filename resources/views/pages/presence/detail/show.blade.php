...
<div class="container my-4">
    ...
    <h4 class="mb-0">Detail Absen</h4>
    <div>
        <button typr="button" onclick="copyLink()" class="btn btn-warning btn-sm">
        ...
        <a href="{{ route('presence.index') }}" class="btn btn-secondary btn-sm">Kembali</a>
    </div>
</div>
   ...
   <div class="card-body">
        <table class="table table-borderless">
            <tr>
                <th class="text-start" style="width: 160px;">Nama Kegiatan</th>
                <td>:&nbsp;&nbsp;{{ $presence->nama_kegiatan }}</td>
            </tr>
            <tr>
                <th class="text-start">Tanggal Kegiatan</th>
                <td>:&nbsp;&nbsp;{{ date('d-m-Y', strtotime($presence->tgl_kegiatan)) }}</td>
            </tr>
            <tr>
                <th class="text-start">Waktu Mulai</th>
...
@endif
    ...
    <td>
        <form action="{{ route('presence-detail.destroy', $detail->id) }}" method="POST" style="display:inline;">
            @csrf
            @method('DELETE')
